...
namespace vsgPotree
{
	...
	struct Attribute
	{
		...
		vsg::dvec3 min = { FLT_MAX, FLT_MAX, FLT_MAX };
		vsg::dvec3 max = { -FLT_MAX, -FLT_MAX, -FLT_MAX };
	...
	class Attributes : public vsg::Inherit<vsg::Object, HNode>
	{
	public:
		vsg::dbox _box;
		...
		vsg::dvec3 _posScale = vsg::dvec3{ 1.0, 1.0, 1.0 };
		vsg::dvec3 _posOffset = vsg::dvec3{ 0.0, 0.0, 0.0 };
